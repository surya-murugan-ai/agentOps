import { Brain, BarChart3, Server, Users, AlertTriangle, Settings, ClipboardList, Activity, Upload, Database, Wrench, Key, TrendingUp, GitBranch, HelpCircle, Cloud, Terminal } from 'lucide-react';
    ...
    <div className="fixed left-0 top-0 h-full w-64 bg-dark-surface border-r border-dark-border z-30 flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-800">
        ...
        <div className="pt-3">
          ...
          <Link href="/remediation-commands" className={getNavItemClass("/remediation-commands")} data-testid="nav-remediation-commands">
            <Terminal size={20} />
        ...
        <div className="pt-3">
          ...
          <Link href="/help" className={getNavItemClass("/help")} data-testid="nav-help">
            <HelpCircle size={20} />
